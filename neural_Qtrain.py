...
INITIAL_EPSILON = 0.6  # starting value of epsilon 0.6
FINAL_EPSILON = 0.1  # final value of epsilon
EPSILON_DECAY_STEPS = 100 #1000
REPLAY_SIZE = 10000  # experience replay buffer size
BATCH_SIZE = 32  # size of minibatch 128
TEST_FREQUENCY =300 # How many episodes to run before visualizing test accuracy 10
SAVE_FREQUENCY = 50  # How many episodes to run before saving model (unused)
NUM_EPISODES = 320  # Episode limitation 100
EP_MAX_STEPS = 300  # Step limitation in an episode 200
# The number of test iters (with epsilon set to 0) to run every TEST_FREQUENCY episodes
NUM_TEST_EPS = 20 #4
HIDDEN_NODES = 20 #5
#these parameters can make it avg 195+ reward in 20 test episodes after training for 180-200 episodes.
...
def get_network(state_dim, action_dim, hidden_nodes=HIDDEN_NODES):
    ...
    optimise_step = tf.train.AdamOptimizer(0.001).minimize(loss)
...
def qtrain(env, state_dim, action_dim,
    ...
    ####for test   
    #print("avg_test_reward:{0}".format(test_reward/20))
    ####
